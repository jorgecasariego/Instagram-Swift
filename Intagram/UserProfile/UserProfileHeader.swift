...
class UserProfileHeader: UICollectionViewCell {
    ...
    @objc func handleEditProfileOrFollow() {
        print("Execute edit profile / follow / unfollow")
    ...
    fileprivate func setupFollowStyle() {
        ...
        self.editProfileFollowButton.backgroundColor = UIColor.rgb(red: 17, green: 154, blue: 244)
    ...
    let followingLabel: UILabel = {
        ...
        attributedText.append(NSAttributedString(string: "followings", attributes: [NSAttributedString.Key.foregroundColor: UIColor.lightGray, NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 14)]))
